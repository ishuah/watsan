...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewEmail'
        db.create_table(u'watsan_newemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('new_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('hash_string', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('watsan', ['NewEmail'])


    def backwards(self, orm):
        # Deleting model 'NewEmail'
        db.delete_table(u'watsan_newemail')
    ...
    models = {
        ...
        'watsan.history': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 14, 14, 8)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 14, 14, 8)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
