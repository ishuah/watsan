...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.date_created'
        db.add_column('watsan_sites', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 17, 15, 25, 56, 1)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.date_created'
        db.delete_column('watsan_sites', 'date_created')
    ...
    models = {
        ...
        'watsan.history': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 15, 25, 56, 1)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 15, 25, 56, 1)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.newemail': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 15, 25, 56, 1)'}),
