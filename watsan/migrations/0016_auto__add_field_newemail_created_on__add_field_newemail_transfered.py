...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewEmail.created_on'
        db.add_column(u'watsan_newemail', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 26, 14, 24, 7)),
                      keep_default=False)

        # Adding field 'NewEmail.transfered'
        db.add_column(u'watsan_newemail', 'transfered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewEmail.created_on'
        db.delete_column(u'watsan_newemail', 'created_on')

        # Deleting field 'NewEmail.transfered'
        db.delete_column(u'watsan_newemail', 'transfered')
    ...
    models = {
        ...
        'watsan.history': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 14, 24, 7)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 14, 24, 7)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.newemail': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 14, 24, 7)'}),
