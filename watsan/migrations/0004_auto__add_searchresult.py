...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('watsan_searchresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('search_engine', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('watsan', ['SearchResult'])

        # Adding model 'Site'
        db.create_table('watsan_sites', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('connection_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 24, 16, 24, 2))),
        ))
        db.send_create_signal('watsan', ['Site'])


    def backwards(self, orm):
        # Deleting model 'SearchResult'
        db.delete_table('watsan_searchresult')
        # Deleting model 'Site'
        db.delete_table('watsan_sites')
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 16, 54, 15, 3)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'place_type': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'watsan.organization': {
            'Meta': {'object_name': 'Organization', 'db_table': "'watsan_organization'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'watsan.site': {
            ...
            'connection_type': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 16, 24, 2)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
