...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('watsan_landmark', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('place_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 28, 11, 42, 33, 1))),
        ))
        db.send_create_signal('watsan', ['Landmark'])


    def backwards(self, orm):
        # Deleting model 'Landmark'
        db.delete_table('watsan_landmark')
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 28, 11, 42, 33, 1)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
