...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Site.connection_type'
        db.delete_column('watsan_sites', 'connection_type')


    def backwards(self, orm):
        # Adding field 'Site.connection_type'
        db.add_column('watsan_sites', 'connection_type',
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 11, 10, 14, 3)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
