...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SewerLine'
        db.create_table('watsan_sewerline', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('watsan', ['SewerLine'])


    def backwards(self, orm):
        # Deleting model 'SewerLine'
        db.delete_table('watsan_sewerline')
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 28, 16, 0, 27, 4)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
