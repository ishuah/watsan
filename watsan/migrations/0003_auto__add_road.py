...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Road'
        db.create_table('watsan_road', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('road_type', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('watsan', ['Road'])


    def backwards(self, orm):
        # Deleting model 'Road'
        db.delete_table('watsan_road')
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 17, 14, 48, 44)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
