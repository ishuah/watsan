...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Landmark.visible'
        db.add_column('watsan_landmark', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Landmark.visible'
        db.delete_column('watsan_landmark', 'visible')
    ...
    models = {
        ...
        'watsan.history': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 12, 9, 13)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 12, 9, 13)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.newemail': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 12, 9, 13)'}),
