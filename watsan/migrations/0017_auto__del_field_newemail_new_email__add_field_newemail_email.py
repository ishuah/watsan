...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewEmail.new_email'
        db.delete_column(u'watsan_newemail', 'new_email')

        # Adding field 'NewEmail.email'
        db.add_column(u'watsan_newemail', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='null', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NewEmail.new_email'
        db.add_column(u'watsan_newemail', 'new_email',
                      self.gf('django.db.models.fields.EmailField')(default='null', max_length=75),
                      keep_default=False)

        # Deleting field 'NewEmail.email'
        db.delete_column(u'watsan_newemail', 'email')
    ...
    models = {
        ...
        'watsan.history': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 17, 38, 5)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 17, 38, 5)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.newemail': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 17, 38, 5)'}),
