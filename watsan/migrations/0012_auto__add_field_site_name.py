...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('watsan_sites', 'name',
                      self.gf('django.db.models.fields.CharField')(default='site with num', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.name'
        db.delete_column('watsan_sites', 'name')
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 11, 13, 25, 3)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
