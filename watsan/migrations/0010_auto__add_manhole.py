...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('watsan_manhole', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('watsan', ['Manhole'])


    def backwards(self, orm):
        # Deleting model 'Manhole'
        db.delete_table('watsan_manhole')
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 17, 15, 10, 48, 2)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
