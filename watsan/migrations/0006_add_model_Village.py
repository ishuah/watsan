...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('watsan_village', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('watsan', ['Village'])


    def backwards(self, orm):
        # Deleting model 'Village'
        db.delete_table('watsan_village')
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 28, 16, 0, 40, 4)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
