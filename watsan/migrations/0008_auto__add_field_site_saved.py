...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.saved'
        db.add_column('watsan_sites', 'saved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.saved'
        db.delete_column('watsan_sites', 'saved')
    ...
    models = {
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 8, 11, 55, 6)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
