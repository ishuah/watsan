...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.color'
        db.add_column('watsan_sites', 'color',
                      self.gf('django.db.models.fields.CharField')(default='white', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.color'
        db.delete_column('watsan_sites', 'color')
    ...
    models = {
        ...
        'watsan.history': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 25, 12, 34, 41, 4)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.landmark': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 25, 12, 34, 41, 4)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'watsan.newemail': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 25, 12, 34, 41, 4)'}),
